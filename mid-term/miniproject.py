...
def parseDetailPageRegex(driver, result, count, skill, key_word, job_company_file):
    detail_page=open("page_detail", "w")
    detail_page.write(driver.page_source)
    ...
    print 'fdskflsdjaflksdjafklsdjfkldsjksdjljkdsfjfj==================='
    if applicants == None:
        driver.back()
    else:
...
driver =webdriver.Chrome('/Users/whaochen/Documents/BIA660/chromedriver' )
